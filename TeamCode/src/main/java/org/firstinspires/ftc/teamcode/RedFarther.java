...
//        rGroup.setFeedforwardCoefficients(0.92, 0.47, 0.3);
        ...
        pidDriveLeft = pidDriveRight = new PIDController(0.005, 0.0001, 0);
...
//        moveArm(3);
    ...
    private void turnPID(double angle) { turnPID(angle, 3); }

    private void turnPID(double angle, int tolerance) {
        lGroup.resetEncoder();
        rGroup.resetEncoder();
