...
@TeleOp(name="RoboOneController", group="OpMode")
public class TeleopGamepadTestingOneContr extends RoboEaglesBase {
    ...
    private double MOTOR_SPEED_MULT = 0.7;//used to be 0.7
    ...
    public void runOpMode() {
     ...
     void checkElbow() {
        double power = -gamepad1.right_stick_y; // Read the Y-axis value of the left joystick and negate it
         double prev_power = 0;
    ...
    void checkArm() {
        //double
        power_arm = -gamepad1.right_stick_x;
        /*if(power_arm < 0) {
            current_arm_pos+= 1;
        }
        else {
