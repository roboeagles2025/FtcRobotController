...
@Autonomous(name = "Autonomous Blue Closer", group = "Autonomous")
@Disabled
public class AutonomousBlueCloser extends RoboEaglesAutonomousBase {
    @Override
